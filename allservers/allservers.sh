#!/bin/bash
# 18-November-2013: Very minor improvement to the menu colour scheme.
#
...
echo -e "       \e[0;33m This Option should be used with care, please read why here: "
echo -e "	\e[0;34mhttps://wiki.archlinux.org/index.php/Pacman#Partial_upgrades_are_unsupported "
echo
...
echo -e "       \e[0;33m &\e[0;32m then run pkgCacheClean: \033[0mpkgcacheclean "
echo
echo -e "       \e[0;33m Read all you need to know about pkgCacheClean here: "
echo -e "    	\e[0;34mhttp://wiki.manjaro.org/index.php/Maintaining_/var/cache/pacman/pkg_for_System_Safety \033[0m"
echo 
